# This migration comes from itsf_fund_reports_engine (originally 16)
class CreateItsfFundReportsTradesOrders < ActiveRecord::Migration
  def change
    create_table :itsf_fund_reports_trades_orders do |t|
    ...
    add_index :itsf_fund_reports_trades_orders, :account_id
    add_index :itsf_fund_reports_trades_orders, :action_id
    add_index :itsf_fund_reports_trades_orders, :currency_id
    add_index :itsf_fund_reports_trades_orders, :asset_category_id
    add_index :itsf_fund_reports_trades_orders, :symbol_id
    add_index :itsf_fund_reports_trades_orders, :security_id
    add_index :itsf_fund_reports_trades_orders, :underlying_symbol_id
    add_index :itsf_fund_reports_trades_orders, :transaction_type_id
    add_index :itsf_fund_reports_trades_orders, :exchange_id
    ...
    add_index :itsf_fund_reports_trades_orders, :order_type_id
    add_index :itsf_fund_reports_trades_orders, :flex_query_run_id
  end
end
